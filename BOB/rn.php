...
<table width="1007" height="117" border="1">
  <tr>
  ...
  <tr>
	...
	<form method="post" action="an.php">
	<label for="Nom">Nom </label> :
	<input name="nom" type="text"  id="nom"size="30" maxlength="20" />
<input name="" type="reset" />	<input name="envoyer" type="submit" />
	</form>
